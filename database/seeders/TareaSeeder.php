...
class TareaSeeder extends Seeder
{
    ...
    {
        //  Listado de trabajo diario, en el orden en que se hace el turno.
        //  Salen el retrolavado y el retiro de quimicos: cada uno tiene su
        //  propia seccion en el formulario.
        $tareas = [
